...
def hornet_spa(in_chans=4,base_dim =32,depths = [2, 3, 3, 2],pretrained=False,in_22k=False, **kwargs):
    s = 1.0/3.0
    model = HorNet(in_chans =in_chans ,depths=depths, base_dim=base_dim, block=Block,
    gnconv=[
